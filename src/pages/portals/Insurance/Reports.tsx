...
const Reports: React.FC = () => {
  ...
  const reportTemplates = [
    ...
    {
      id: 'RPT-003',
      name: 'Policy Portfolio Analysis',
      type: 'Portfolio',
      frequency: 'Monthly',
  ...
  const reportStats = [
    { label: 'Total Reports', value: '67', change: '+9', trend: 'up' },
    { label: 'Generated This Month', value: '18', change: '+4', trend: 'up' },
    { label: 'Pending Reports', value: '7', change: '-1', trend: 'down' },
    { label: 'Average Generation Time', value: '2.8 min', change: '-12%', trend: 'down' }
  ];
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 font-serif mt-2">Generate and manage insurance reports</p>
          </div>
