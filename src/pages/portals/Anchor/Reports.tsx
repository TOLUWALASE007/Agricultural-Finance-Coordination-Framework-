...
const Reports: React.FC = () => {
  ...
  const reportTemplates = [
    ...
    {
      id: 'RPT-002',
      name: 'Contract Performance Summary',
      type: 'Contract',
      frequency: 'Quarterly',
  ...
  const reportStats = [
    { label: 'Total Reports', value: '45', change: '+6', trend: 'up' },
    { label: 'Generated This Month', value: '8', change: '+2', trend: 'up' },
    { label: 'Pending Reports', value: '3', change: '-1', trend: 'down' },
    { label: 'Average Generation Time', value: '1.8 min', change: '-15%', trend: 'down' }
  ];
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 font-serif mt-2">Generate and manage anchor company reports</p>
          </div>
