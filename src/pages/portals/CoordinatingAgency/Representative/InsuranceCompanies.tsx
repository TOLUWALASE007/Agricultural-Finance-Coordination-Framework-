...
const RepresentativeInsurance: React.FC = () => {
  const sidebarItems = [
    { 
      id: 'dashboard', 
      name: 'Dashboard', 
  ...
  const reports = [
    { id: 'r1', company: 'AIICO Insurance PLC', title: 'Q3 Claims Summary', date: '2025-09-28', state: 'Lagos' },
    { id: 'r2', company: 'Leadway Assurance', title: 'Portfolio Coverage Update', date: '2025-09-22', state: 'Lagos' },
    { id: 'r3', company: 'AXA Mansard', title: 'Risk Exposure Report', date: '2025-09-15', state: 'FCT Abuja' },
    { id: 'r4', company: 'Custodian Investment', title: 'Agric Claims Dashboard', date: '2025-09-08', state: 'Oyo' },
    { id: 'r5', company: 'Cornerstone Insurance', title: 'Quarterly Loss Ratio', date: '2025-09-05', state: 'Lagos' },
    { id: 'r6', company: 'Mutual Benefits', title: 'Claims Turnaround Time', date: '2025-09-01', state: 'Ogun' }
  ];

  const filtered = useMemo(() => reports.filter(r => {
    const s = search.toLowerCase();
    const matchesText = r.company.toLowerCase().includes(s) || r.title.toLowerCase().includes(s);
    ...
    <PortalLayout role="Coordinating Agency" roleIcon="🏛️" sidebarItems={sidebarItems}>
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold font-sans text-gray-100 mb-2">Insurance Companies</h1>
            <p className="text-gray-400 font-serif">Receive and manage reports submitted by insurance companies participating in AFCF schemes</p>
          </div>
        ...
        <div className="bg-primary-800 rounded-lg shadow-lg p-4 sm:p-6">
          <div className="flex flex-col gap-3 mb-4">
            <div className="relative flex-1">
              <input value={search} onChange={(e) => { setPage(1); setSearch(e.target.value); }} placeholder="Search reports or companies..." className="w-full px-3 py-2 pr-10 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm font-serif">{r.company} • {r.state} • {r.date}</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="w-full max-w-lg bg-primary-800 border border-primary-700 rounded-lg shadow-xl">
            ...
            <div className="p-4 space-y-4">
              <div>
                ...
                <input value={orgName} onChange={(e) => setOrgName(e.target.value)} placeholder="e.g., AIICO Insurance PLC" className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
              </div>
              <div>
              ...
              <div>
                ...
                <input value={reportTitle} onChange={(e) => setReportTitle(e.target.value)} placeholder="e.g., Q4 Claims Summary" className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
              </div>
            </div>
...
export default RepresentativeInsurance;
