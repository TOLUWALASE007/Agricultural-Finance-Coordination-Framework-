...
const WardMonitoring: React.FC = () => {
  ...
  // Ward Monitoring Reports - Comprehensive Dummy Data
  const monitoringReports = [
    {
      id: '1',
      title: 'Alausa Ward Agricultural Credit Access Assessment',
      state: 'Lagos',
      lga: 'Ikeja',
      ward: 'Alausa',
      reportType: 'Credit Access',
      date: '2024-01-15',
      status: 'Completed',
      priority: 'High',
      findings: 'Credit access improved to 85% among ward farmers',
      recommendations: 'Expand mobile banking services to reach more farmers',
      assignedTo: 'Mr. Adebayo Johnson',
      completionRate: 100,
      farmersReached: 450,
      creditDisbursed: '₦8.5M',
      villagesCovered: 3
    },
    {
      id: '2',
      title: 'Nasarawa Ward Cooperative Society Performance',
      state: 'Kano',
      lga: 'Kano Municipal',
      ward: 'Nasarawa',
      reportType: 'Cooperative Performance',
      date: '2024-01-12',
      status: 'In Progress',
      priority: 'High',
      findings: 'Cooperative performance excellent with 95% repayment rate',
      recommendations: 'Support formation of new cooperatives in neighboring wards',
      assignedTo: 'Dr. Aisha Mohammed',
      completionRate: 80,
      farmersReached: 680,
      creditDisbursed: '₦12.2M',
      villagesCovered: 4
    },
    {
      id: '3',
      title: 'Diobu Ward Insurance Coverage Assessment',
      state: 'Rivers',
      lga: 'Port Harcourt',
      ward: 'Diobu',
      ...
      status: 'Completed',
      priority: 'Medium',
      findings: 'Insurance coverage at 32% among ward farmers',
      recommendations: 'Increase awareness campaigns in rural communities',
      assignedTo: 'Ms. Blessing Okafor',
      completionRate: 100,
      farmersReached: 320,
      creditDisbursed: '₦6.8M',
      villagesCovered: 2
    },
    {
      id: '4',
      title: 'Unguwan Rimi Youth Agricultural Program',
      state: 'Kaduna',
      lga: 'Kaduna North',
      ward: 'Unguwan Rimi',
      ...
      status: 'In Progress',
      priority: 'High',
      findings: 'Youth participation in agriculture increased by 40%',
      recommendations: 'Create more youth-focused agricultural programs',
      assignedTo: 'Mr. Ibrahim Garba',
      completionRate: 75,
      farmersReached: 280,
      creditDisbursed: '₦5.2M',
      villagesCovered: 3
    },
    {
      id: '5',
      title: 'Bodija Ward Extension Services Impact',
      state: 'Oyo',
      lga: 'Ibadan North',
      ward: 'Bodija',
      ...
      status: 'Completed',
      priority: 'Medium',
      findings: 'Extension services led to 30% increase in crop yields',
      recommendations: 'Expand extension services to more farming communities',
      assignedTo: 'Dr. Tunde Adebayo',
      completionRate: 100,
      farmersReached: 520,
      creditDisbursed: '₦9.8M',
      villagesCovered: 5
    },
    {
      id: '6',
      title: 'Gwandu Ward Rice Farmers Credit Assessment',
      state: 'Kebbi',
      lga: 'Birnin Kebbi',
      ward: 'Gwandu',
      ...
      recommendations: 'Develop rice-specific credit products for ward farmers',
      assignedTo: 'Mr. Usman Garba',
      completionRate: 90,
      farmersReached: 380,
      creditDisbursed: '₦7.5M',
      villagesCovered: 3
    },
    {
      id: '7',
      title: 'Wurukum Ward Cassava Processing Finance',
      state: 'Benue',
      lga: 'Makurdi',
      ward: 'Wurukum',
      ...
      completionRate: 100,
      farmersReached: 340,
      creditDisbursed: '₦8.2M',
      villagesCovered: 4
    },
    {
      id: '8',
      title: 'Ganmo Ward Women Agricultural Finance',
      state: 'Kwara',
      lga: 'Ilorin East',
      ward: 'Ganmo',
      ...
      completionRate: 70,
      farmersReached: 280,
      creditDisbursed: '₦6.5M',
      villagesCovered: 3
    },
    {
      id: '9',
      title: 'Rijiyar Zaki Climate-Resilient Agriculture',
      state: 'Sokoto',
      lga: 'Sokoto North',
      ward: 'Rijiyar Zaki',
      ...
      recommendations: 'Implement climate insurance products for ward farmers',
      assignedTo: 'Dr. Amina Hassan',
      completionRate: 100,
      farmersReached: 420,
      creditDisbursed: '₦9.2M',
      villagesCovered: 4
    },
    {
      id: '10',
      title: 'Calabar South Ward Cocoa Farmers Credit',
      state: 'Cross River',
      ...
      completionRate: 65,
      farmersReached: 220,
      creditDisbursed: '₦4.8M',
      villagesCovered: 2
    },
    {
      id: '11',
      title: 'Jos Ward Potato Farmers Financial Inclusion',
      state: 'Plateau',
      lga: 'Jos North',
      ward: 'Jos',
      ...
      status: 'Completed',
      priority: 'Medium',
      findings: 'Financial inclusion rate improved to 42% among potato farmers',
      recommendations: 'Expand mobile banking services in rural areas',
      assignedTo: 'Dr. Sarah Ibrahim',
      completionRate: 100,
      farmersReached: 310,
      creditDisbursed: '₦6.2M',
      villagesCovered: 3
    },
    {
      id: '12',
      title: 'Effurun Ward Oil Palm Farmers Credit',
      state: 'Delta',
      lga: 'Warri South',
      ward: 'Effurun',
  ...
  const stats = [
    { title: 'Wards Monitored', value: monitoringReports.length.toString(), change: '+8', icon: '🏡' },
    { title: 'Total Farmers Reached', value: (monitoringReports.reduce((sum, r) => sum + r.farmersReached, 0) / 1000).toFixed(1) + 'K', change: '+1.2K', icon: '👥' },
    { title: 'Credit Disbursed', value: '₦' + (monitoringReports.reduce((sum, r) => sum + parseFloat(r.creditDisbursed.replace('₦', '').replace('M', '')), 0)).toFixed(1) + 'M', change: '+₦15M', icon: '💼' },
    { title: 'Villages Covered', value: monitoringReports.reduce((sum, r) => sum + r.villagesCovered, 0).toString(), change: '+12', icon: '🏘️' }
  ];

  return (
    <PortalLayout role="Ward Monitoring Department" roleIcon="🏡" sidebarItems={sidebarItems}>
      <div className="space-y-6">
        {/* Header */}
        <div className="bg-primary-800 rounded-lg p-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-white mb-2">Ward Monitoring Department</h1>
              <p className="text-gray-300">
                Ward-level monitoring and grassroots implementation of agricultural finance programs
              </p>
            </div>
        ...
        {/* Ward Monitoring Reports Management */}
        <div className="bg-primary-800 rounded-lg p-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <h2 className="text-xl font-semibold text-white">Ward Monitoring Reports</h2>
            <div className="flex flex-col sm:flex-row gap-3">
              <select
                value={stateFilter}
            ...
            <div className="bg-accent-600 rounded-lg p-4 mb-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button 
                    onClick={() => handleMassAction('Forward to LGA')}
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-primary-700">
                  ...
                  <th className="text-left py-3 px-4 text-gray-300 font-medium">Villages</th>
                  ...
                  <tr key={report.id} className="border-b border-primary-700 hover:bg-primary-700/50">
                    ...
                    <td className="py-3 px-4">
                      <div>
                        ...
                        <p className="text-gray-400 text-xs">{report.ward}</p>
                      </div>
                    </td>
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4 text-gray-300">{report.farmersReached}</td>
                    <td className="py-3 px-4 text-gray-300">{report.creditDisbursed}</td>
                    <td className="py-3 px-4 text-gray-300">{report.villagesCovered}</td>
        ...
        <div className="bg-primary-800 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button className="btn-secondary">
              📈 View Ward Analytics Dashboard
            </button>
            <button className="btn-secondary">
              📋 Export All Ward Reports
            </button>
          </div>
        </div>
