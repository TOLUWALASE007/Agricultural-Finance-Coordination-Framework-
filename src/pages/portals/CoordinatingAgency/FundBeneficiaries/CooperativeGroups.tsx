...
const CooperativeGroups: React.FC = () => {
    ...
    const operationsEntries = buildEntries(
      {
        ...
        areasOfOperation: Array.isArray(step5.areasOfOperation) ? step5.areasOfOperation.join(', ') : step5.areasOfOperation,
    ...
    return (
      <div className="mt-4 space-y-6 bg-primary-800 rounded-md p-4">
        ...
        <div className="space-y-4">
          ...
          {renderGroup('Organization Information', organizationEntries)}
          {renderGroup(
  ...
  }, [cooperativeGroups, approveStateFilter, approveSearch]);
  ...
  // Filters and pagination (Restrict) - ONLY Approved (verified) Cooperative Groups
  ...
  }, [cooperativeGroups, restrictStateFilter, restrictSearch]);
  ...
  // Filter for Approval Rights - Cooperative Groups who applied for schemes (using notifications)
    ...
    <PortalLayout role="Cooperative Groups" roleIcon="🤝" sidebarItems={sidebarItems}>
      <div className="space-y-6">
              ...
              <div className="min-h-screen flex items-center justify-center py-8">
                <div className="w-full max-w-3xl bg-primary-900 rounded-lg border border-primary-700 p-6" onClick={(e) => e.stopPropagation()}>
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-semibold font-sans text-gray-100">Cooperative Group Application</h3>
                      <div className="mt-2 p-3 bg-primary-800 rounded-md">
                        <p className="text-xs text-accent-400 font-sans font-medium mb-1">🤝 Cooperative Group</p>
            ...
            <div className="fixed inset-0 z-50 bg-black/60 p-4 overflow-y-auto" onClick={() => setShowApprovalModal(null)}>
              <div className="min-h-screen flex items-center justify-center py-8">
                <div className="w-full max-w-3xl bg-primary-900 rounded-lg border border-primary-700 p-6" onClick={(e) => e.stopPropagation()}>
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-semibold font-sans text-gray-100">Cooperative Group Application Review</h3>
                      <div className="mt-2 p-3 bg-primary-800 rounded-md">
                        <p className="text-xs text-accent-400 font-sans font-medium mb-1">🤝 Cooperative Group</p>
                        <p className="text-sm text-gray-200">{user.organization} - Registration Application</p>
                      </div>
          ...
          <div className="flex-grow overflow-y-auto custom-scrollbar">
            {paginatedRestrictUsers.length > 0 ? (
              ...
              <div className="text-center py-10">
                <div className="text-4xl mb-2">✅</div>
                <p className="text-gray-400 font-sans">No approved Cooperative Groups found</p>
              </div>
            )}
          </div>
        ...
        {showRestrictMoreInfo && (() => {
          const user = cooperativeGroups.find(u => u.id === showRestrictMoreInfo);
          return user ? (
