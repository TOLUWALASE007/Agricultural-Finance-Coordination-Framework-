      ...
      <div className="space-y-6">
        ...
        <div className="bg-primary-800 rounded-lg p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6">
            <p className="text-gray-400 text-xs sm:text-sm">Showing {((approvePage - 1) * pageSize) + 1} to {Math.min(approvePage * pageSize, filteredApproveUsers.length)} of {filteredApproveUsers.length} groups</p>
            <div className="flex gap-2">
        ...
        <div className="bg-primary-800 rounded-lg p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6">
            <p className="text-gray-400 text-xs sm:text-sm">Showing {((editPage - 1) * pageSize) + 1} to {Math.min(editPage * pageSize, filteredEditUsers.length)} of {filteredEditUsers.length} groups</p>
            <div className="flex gap-2">
        ...
        <div className="bg-primary-800 rounded-lg p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6">
            <p className="text-gray-400 text-xs sm:text-sm">Showing {((restrictPage - 1) * pageSize) + 1} to {Math.min(restrictPage * pageSize, filteredRestrictUsers.length)} of {filteredRestrictUsers.length} groups</p>
            <div className="flex gap-2">
        ...
        <div className="bg-primary-800 rounded-lg p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6">
            <p className="text-gray-400 text-xs sm:text-sm">Showing {((approvalRightsPage - 1) * pageSize) + 1} to {Math.min(approvalRightsPage * pageSize, filteredRightsUsers.length)} of {filteredRightsUsers.length} groups</p>
            <div className="flex gap-2">
