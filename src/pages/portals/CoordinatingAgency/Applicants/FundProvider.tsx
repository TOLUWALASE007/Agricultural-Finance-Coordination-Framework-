...
const FundProviderApplicants: React.FC = () => {
  ...
  const handleMassApprovalRights = () => {
    ...
    alert(`Updated approval rights for ${selectedApprovalRightsUsers.length} Fund Provider users`);
    setSelectedApprovalRightsUsers([]);
  };

  // Select-all for each list (current page only)
  ...
  return (
    <PortalLayout role="Fund Provider Applicants" roleIcon="💼" sidebarItems={sidebarItems}>
      <div className="space-y-6">
        {/* Header */}
        <div className="bg-primary-800 rounded-lg p-4 sm:p-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-white mb-2">Fund Provider Applicants</h1>
              <p className="text-gray-300">
                Manage access, permissions, and approval rights for Fund Provider applicants
              </p>
            </div>
        ...
        {showRestrictModal && (() => {
          const user = fundProviderApplicants.find(u => u.id === showRestrictModal);
          return user ? (
            ...
            <div className="min-h-screen flex items-center justify-center py-8">
              <div className="w-full max-w-xl bg-primary-900 rounded-lg border border-primary-700 p-6" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-lg font-semibold text-gray-100">Approve Access - History</h3>
          ...
          <div className="fixed inset-0 z-50 bg-black/60 p-4 overflow-y-auto" onClick={() => setShowRestrictHistory(false)}>
            <div className="min-h-screen flex items-center justify-center py-8">
              <div className="w-full max-w-xl bg-primary-900 rounded-lg border border-primary-700 p-6" onClick={(e) => e.stopPropagation()}>
                ...
                <ul className="space-y-2 text-gray-100 text-sm">
                  <li>2024-10-03 • Restricted 1 user due to non-compliance</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="fixed inset-0 z-50 bg-black/60 p-4 overflow-y-auto" onClick={() => setShowApprovalRightsHistory(false)}>
            <div className="min-h-screen flex items-center justify-center py-8">
              <div className="w-full max-w-xl bg-primary-900 rounded-lg border border-primary-700 p-6" onClick={(e) => e.stopPropagation()}>
                ...
                <ul className="space-y-2 text-gray-100 text-sm">
                  <li>2024-10-04 • Granted approval rights to AgriInvest Partners</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="min-h-screen flex items-center justify-center py-8">
              <div className="w-full max-w-md bg-primary-900 rounded-lg border border-primary-700 p-6" onClick={(e) => e.stopPropagation()}>
                ...
                <p className="text-gray-200 mb-4">
                  🚫 Access for <span className="font-semibold">{restrictConfirm.name}</span> restricted. Reason: <span className="font-semibold">{restrictConfirm.reason}</span>.
                </p>
                <div className="flex justify-end">
                  <button onClick={() => setRestrictConfirm(null)} className="btn-primary">Close</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="fixed inset-0 z-50 bg-black/60 p-4 overflow-y-auto" onClick={() => setRightsConfirm(null)}>
            <div className="min-h-screen flex items-center justify-center py-8">
              <div className="w-full max-w-md bg-primary-900 rounded-lg border border-primary-700 p-6" onClick={(e) => e.stopPropagation()}>
                ...
                <p className="text-gray-200 mb-4">
                  ✅ Rights for <span className="font-semibold">{rightsConfirm.name}</span>: <span className="font-semibold">{rightsConfirm.decision}</span>.
                </p>
                <div className="flex justify-end">
                  <button onClick={() => setRightsConfirm(null)} className="btn-primary">Close</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="w-full max-w-md bg-primary-900 border border-primary-700 rounded-lg p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-300 font-serif mt-2">
                    Restrict access for {selectedRestrictUsers.length} selected Fund Provider users
                  </p>
                </div>
                <button
...
export default FundProviderApplicants;
