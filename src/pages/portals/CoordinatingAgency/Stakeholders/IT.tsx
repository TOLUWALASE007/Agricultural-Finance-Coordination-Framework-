...
const IT: React.FC = () => {
  ...
  const [newDeptName, setNewDeptName] = useState('IT Department');
  const [newDeptDesc, setNewDeptDesc] = useState('');
  const [newContactName, setNewContactName] = useState('');
  const [newContactEmail, setNewContactEmail] = useState('');
  const [newContactPhone, setNewContactPhone] = useState('');

  // Dummy data for reports from IT Department
  const reports = [
    { id: 'ITD-REP-001', title: 'Q1 2024 IT Infrastructure Report', teamName: 'Infrastructure Team Alpha', date: '2024-03-31', fileUrl: `${process.env.PUBLIC_URL}/docs/it-q1-infrastructure-2024.pdf` },
    { id: 'ITD-REP-002', title: 'System Performance Summary - April 2024', teamName: 'Performance Team Beta', date: '2024-04-30', fileUrl: `${process.env.PUBLIC_URL}/docs/it-performance-april-2024.pdf` },
    { id: 'ITD-REP-003', title: 'Cybersecurity Assessment Analysis', teamName: 'Security Team Gamma', date: '2024-05-15', fileUrl: `${process.env.PUBLIC_URL}/docs/it-security-2024.pdf` },
    { id: 'ITD-REP-004', title: 'Vendor Management Report Q2 2024', teamName: 'Vendor Management Team Delta', date: '2024-06-30', fileUrl: `${process.env.PUBLIC_URL}/docs/it-vendor-q2-2024.pdf` },
    { id: 'ITD-REP-005', title: 'Digital Platform Performance', teamName: 'Platform Team Epsilon', date: '2024-07-20', fileUrl: `${process.env.PUBLIC_URL}/docs/it-platform-july-2024.pdf` },
    { id: 'ITD-REP-006', title: 'IT Vendor Compliance Audit', teamName: 'Compliance Team Zeta', date: '2024-08-10', fileUrl: `${process.env.PUBLIC_URL}/docs/it-compliance-audit-2024.pdf` },
    { id: 'ITD-REP-007', title: 'Quarterly IT Dashboard Q3 2024', teamName: 'Dashboard Team Theta', date: '2024-09-30', fileUrl: `${process.env.PUBLIC_URL}/docs/it-dashboard-q3-2024.pdf` },
    { id: 'ITD-REP-008', title: 'Annual IT Management Review 2024', teamName: 'Management Review Team Iota', date: '2024-12-15', fileUrl: `${process.env.PUBLIC_URL}/docs/it-annual-review-2024.pdf` },
  ];
  ...
  return (
    <PortalLayout role="Coordinating Agency" roleIcon="🏛️" sidebarItems={sidebarItems}>
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            ...
            <p className="text-gray-400 font-serif">
              Manage technology infrastructure, digital platforms, cybersecurity, and IT systems for agricultural finance operations
            </p>
          </div>
        ...
        {/* Main Content Card */}
        <div className="bg-primary-800 rounded-lg shadow-lg p-4 sm:p-6">
          <h2 className="text-xl font-semibold font-sans text-gray-100 mb-4">IT Vendor Management</h2>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input value={newContactName} onChange={(e) => setNewContactName(e.target.value)} placeholder="e.g., IT Lead" className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
                </div>
                <div>
