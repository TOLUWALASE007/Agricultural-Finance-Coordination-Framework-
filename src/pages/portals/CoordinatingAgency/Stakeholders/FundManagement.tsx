...
const FundManagement: React.FC = () => {
  ...
  const [newDeptName, setNewDeptName] = useState('Fund Management Department');
  const [newDeptDesc, setNewDeptDesc] = useState('');
  const [newContactName, setNewContactName] = useState('');
  const [newContactEmail, setNewContactEmail] = useState('');
  const [newContactPhone, setNewContactPhone] = useState('');

  // Dummy data for reports from Fund Management Department
  const reports = [
    { id: 'FMD-REP-001', title: 'Q1 2024 Fund Allocation Report', teamName: 'Allocation Team Alpha', date: '2024-03-31', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-q1-allocation-2024.pdf` },
    { id: 'FMD-REP-002', title: 'Monthly Disbursement Summary - April 2024', teamName: 'Disbursement Team Beta', date: '2024-04-30', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-april-disbursement-2024.pdf` },
    { id: 'FMD-REP-003', title: 'Fund Recovery Performance Analysis', teamName: 'Recovery Team Gamma', date: '2024-05-15', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-recovery-analysis-2024.pdf` },
    { id: 'FMD-REP-004', title: 'Budget Utilization Report Q2 2024', teamName: 'Budget Team Delta', date: '2024-06-30', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-budget-q2-2024.pdf` },
    { id: 'FMD-REP-005', title: 'Loan Portfolio Status Update', teamName: 'Portfolio Team Epsilon', date: '2024-07-20', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-portfolio-july-2024.pdf` },
    { id: 'FMD-REP-006', title: 'Fund Management Compliance Audit', teamName: 'Compliance Team Zeta', date: '2024-08-10', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-compliance-audit-2024.pdf` },
    { id: 'FMD-REP-007', title: 'Quarterly Financial Statement Q3 2024', teamName: 'Finance Team Theta', date: '2024-09-30', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-financial-q3-2024.pdf` },
    { id: 'FMD-REP-008', title: 'Annual Fund Performance Review 2024', teamName: 'Performance Team Iota', date: '2024-12-15', fileUrl: `${process.env.PUBLIC_URL}/docs/fmd-annual-review-2024.pdf` },
  ];
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            ...
            <p className="text-gray-400 font-serif">
              Manage fund allocation, deployment, and recovery across all agricultural finance schemes
            </p>
          </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Brief purpose and scope of the department..."
                  className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500"
                />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input value={newContactName} onChange={(e) => setNewContactName(e.target.value)} placeholder="e.g., Fund Mgmt Lead" className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
                </div>
                <div>
