...
const Legal: React.FC = () => {
  ...
  const [newDeptName, setNewDeptName] = useState('Legal Department');
  const [newDeptDesc, setNewDeptDesc] = useState('');
  const [newContactName, setNewContactName] = useState('');
  const [newContactEmail, setNewContactEmail] = useState('');
  const [newContactPhone, setNewContactPhone] = useState('');

  // Dummy data for reports from Legal Department
  const reports = [
    { id: 'LEG-REP-001', title: 'Q1 2024 Legal Compliance Report', teamName: 'Compliance Team Alpha', date: '2024-03-31', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-q1-compliance-2024.pdf` },
    { id: 'LEG-REP-002', title: 'Contract Review Summary - April 2024', teamName: 'Contract Review Team Beta', date: '2024-04-30', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-contracts-april-2024.pdf` },
    { id: 'LEG-REP-003', title: 'Dispute Resolution Analysis', teamName: 'Dispute Resolution Team Gamma', date: '2024-05-15', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-disputes-2024.pdf` },
    { id: 'LEG-REP-004', title: 'Regulatory Update Report Q2 2024', teamName: 'Regulatory Team Delta', date: '2024-06-30', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-regulatory-q2-2024.pdf` },
    { id: 'LEG-REP-005', title: 'Legal Risk Assessment Performance', teamName: 'Risk Assessment Team Epsilon', date: '2024-07-20', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-risk-july-2024.pdf` },
    { id: 'LEG-REP-006', title: 'Partner Compliance Audit', teamName: 'Audit Team Zeta', date: '2024-08-10', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-audit-2024.pdf` },
    { id: 'LEG-REP-007', title: 'Quarterly Legal Dashboard Q3 2024', teamName: 'Dashboard Team Theta', date: '2024-09-30', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-dashboard-q3-2024.pdf` },
    { id: 'LEG-REP-008', title: 'Annual Legal Management Review 2024', teamName: 'Management Review Team Iota', date: '2024-12-15', fileUrl: `${process.env.PUBLIC_URL}/docs/leg-annual-review-2024.pdf` },
  ];
  ...
  return (
    <PortalLayout role="Coordinating Agency" roleIcon="🏛️" sidebarItems={sidebarItems}>
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            ...
            <p className="text-gray-400 font-serif">
              Manage legal compliance, contract reviews, dispute resolution, and regulatory matters for agricultural finance
            </p>
          </div>
        ...
        {/* Main Content Card */}
        <div className="bg-primary-800 rounded-lg shadow-lg p-4 sm:p-6">
          <h2 className="text-xl font-semibold font-sans text-gray-100 mb-4">Legal Partner Management</h2>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input value={newContactName} onChange={(e) => setNewContactName(e.target.value)} placeholder="e.g., Legal Lead" className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
                </div>
                <div>
