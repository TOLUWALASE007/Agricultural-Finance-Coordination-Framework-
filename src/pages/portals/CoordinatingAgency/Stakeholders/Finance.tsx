...
const Finance: React.FC = () => {
  ...
  const [newDeptName, setNewDeptName] = useState('Finance and Accounting Department');
  const [newDeptDesc, setNewDeptDesc] = useState('');
  const [newContactName, setNewContactName] = useState('');
  const [newContactEmail, setNewContactEmail] = useState('');
  const [newContactPhone, setNewContactPhone] = useState('');

  // Dummy data for reports from Finance and Accounting Department
  const reports = [
    { id: 'FIN-REP-001', title: 'Q1 2024 Financial Statement Report', teamName: 'Financial Reporting Team Alpha', date: '2024-03-31', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-q1-statement-2024.pdf` },
    { id: 'FIN-REP-002', title: 'Budget Allocation Summary - April 2024', teamName: 'Budget Team Beta', date: '2024-04-30', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-budget-april-2024.pdf` },
    { id: 'FIN-REP-003', title: 'Disbursement Analysis Report', teamName: 'Disbursement Team Gamma', date: '2024-05-15', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-disbursement-2024.pdf` },
    { id: 'FIN-REP-004', title: 'Audit Compliance Report Q2 2024', teamName: 'Audit Team Delta', date: '2024-06-30', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-audit-q2-2024.pdf` },
    { id: 'FIN-REP-005', title: 'Revenue Tracking Performance', teamName: 'Revenue Tracking Team Epsilon', date: '2024-07-20', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-revenue-july-2024.pdf` },
    { id: 'FIN-REP-006', title: 'Institution Financial Health Assessment', teamName: 'Assessment Team Zeta', date: '2024-08-10', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-health-assessment-2024.pdf` },
    { id: 'FIN-REP-007', title: 'Quarterly Accounting Dashboard Q3 2024', teamName: 'Dashboard Team Theta', date: '2024-09-30', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-dashboard-q3-2024.pdf` },
    { id: 'FIN-REP-008', title: 'Annual Financial Management Review 2024', teamName: 'Management Review Team Iota', date: '2024-12-15', fileUrl: `${process.env.PUBLIC_URL}/docs/fin-annual-review-2024.pdf` },
  ];
  ...
  return (
    <PortalLayout role="Coordinating Agency" roleIcon="🏛️" sidebarItems={sidebarItems}>
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            ...
            <p className="text-gray-400 font-serif">
              Manage financial operations, budgeting, disbursements, and accounting for all agricultural finance programs
            </p>
          </div>
        ...
        {/* Main Content Card */}
        <div className="bg-primary-800 rounded-lg shadow-lg p-4 sm:p-6">
          <h2 className="text-xl font-semibold font-sans text-gray-100 mb-4">Financial Institution Management</h2>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input value={newContactName} onChange={(e) => setNewContactName(e.target.value)} placeholder="e.g., Finance Lead" className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
                </div>
                <div>
