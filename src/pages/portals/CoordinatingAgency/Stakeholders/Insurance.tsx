...
const Insurance: React.FC = () => {
  ...
  const [newDeptName, setNewDeptName] = useState('Agricultural Insurance Management Department');
  const [newDeptDesc, setNewDeptDesc] = useState('');
  const [newContactName, setNewContactName] = useState('');
  const [newContactEmail, setNewContactEmail] = useState('');
  const [newContactPhone, setNewContactPhone] = useState('');

  // Dummy data for reports from Insurance Management Department
  const reports = [
    { id: 'INS-REP-001', title: 'Q1 2024 Insurance Coverage Report', teamName: 'Coverage Team Alpha', date: '2024-03-31', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-q1-coverage-2024.pdf` },
    { id: 'INS-REP-002', title: 'Claims Processing Summary - April 2024', teamName: 'Claims Processing Team Beta', date: '2024-04-30', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-claims-april-2024.pdf` },
    { id: 'INS-REP-003', title: 'Policy Renewal Analysis', teamName: 'Policy Management Team Gamma', date: '2024-05-15', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-policy-renewal-2024.pdf` },
    { id: 'INS-REP-004', title: 'Risk Assessment Report Q2 2024', teamName: 'Risk Assessment Team Delta', date: '2024-06-30', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-risk-q2-2024.pdf` },
    { id: 'INS-REP-005', title: 'Premium Collection Performance', teamName: 'Premium Collection Team Epsilon', date: '2024-07-20', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-premium-july-2024.pdf` },
    { id: 'INS-REP-006', title: 'Insurance Provider Compliance Audit', teamName: 'Compliance Team Zeta', date: '2024-08-10', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-compliance-audit-2024.pdf` },
    { id: 'INS-REP-007', title: 'Quarterly Insurance Dashboard Q3 2024', teamName: 'Dashboard Team Theta', date: '2024-09-30', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-dashboard-q3-2024.pdf` },
    { id: 'INS-REP-008', title: 'Annual Insurance Management Review 2024', teamName: 'Management Review Team Iota', date: '2024-12-15', fileUrl: `${process.env.PUBLIC_URL}/docs/ins-annual-review-2024.pdf` },
  ];
  ...
  return (
    <PortalLayout role="Coordinating Agency" roleIcon="🏛️" sidebarItems={sidebarItems}>
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold font-sans text-gray-100 mb-2">
              Agricultural Insurance Management Department
            </h1>
            <p className="text-gray-400 font-serif">
              Oversee agricultural insurance policies, claims processing, and risk coverage across all schemes
            </p>
          </div>
        ...
        {/* Main Content Card */}
        <div className="bg-primary-800 rounded-lg shadow-lg p-4 sm:p-6">
          <h2 className="text-xl font-semibold font-sans text-gray-100 mb-4">Insurance Provider Management</h2>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input value={newContactName} onChange={(e) => setNewContactName(e.target.value)} placeholder="e.g., Insurance Lead" className="w-full px-3 py-2 rounded-md bg-primary-700 text-gray-100 placeholder-gray-400 border border-primary-600 focus:outline-none focus:ring-2 focus:ring-accent-500" />
                </div>
                <div>
