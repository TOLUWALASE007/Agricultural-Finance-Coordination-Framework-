...
const Reports: React.FC = () => {
  ...
  const reportTemplates = [
    ...
    {
      id: 'RPT-003',
      name: 'M&E Performance Dashboard',
      type: 'Monitoring',
      frequency: 'Monthly',
  ...
  const reportStats = [
    { label: 'Total Reports', value: '78', change: '+9', trend: 'up' },
    { label: 'Generated This Month', value: '15', change: '+3', trend: 'up' },
    { label: 'Pending Reports', value: '6', change: '-1', trend: 'down' },
    { label: 'Average Generation Time', value: '2.5 min', change: '-10%', trend: 'down' }
  ];
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 font-serif mt-2">Generate and manage project management reports</p>
          </div>
